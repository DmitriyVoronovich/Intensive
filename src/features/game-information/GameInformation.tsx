      ...
      <div className={css.content}>
        ...
        <div className={css.block_game_information}>
          <ul className={css.game_information}>
            <li className={css.information}>Дата обновления: <span className='style_word'>{details.updated}</span></li>
            ...
            <li className={css.information}>Официальный сайт: <a className='style_web' href={details.website} target="_blank">{details.website}</a></li>
            <li className={css.information}>Обновление: <span className='style_word'>{details.updated}</span></li>
            <li className={css.information}>Релиз: <span className='style_word'>{details.released}</span></li>
            <li className={css.information}>Время игры: <span className='style_word'>{details.playtime} h</span> </li>
          </ul>
        </div>  
      </div>
    </div>
